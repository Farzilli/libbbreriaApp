...
public class LibriList extends AppCompatActivity implements IManageComponents, IManageIntents {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.hideBar(this);
        setContentView(R.layout.activity_libri_list);
        ...
        this.df.get(Config.ProductApi.LIBRI, "data", new DataFetcher.DataListener() {
            @Override
    ...
    @Override
    public void changeIntent(Class intent) {
        this.vibrate(this.context, 50);
